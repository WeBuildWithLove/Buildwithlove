    ...
    <section className="max-container padding-container mb:mb-28">
      <div className="mb-9">
        ...
        <p className="text-[10px] md:text-xl md:leading-[31.2px] text-center font-light">
          Our client&apos;s feedback is a testament to our dedication,
          creativity, and expertise. Read on to see how we have transformed
          businesses, enhanced online presence, and created seamless digital
      ...
      <div className="border my-16 md:my-40 border-solid border-[#E1E1E1] rounded-xl px-8 md:px-32 lg:px-64 py-8 md:py-16 relative max-w-[1080px] mx-auto">
        ...
        <div>
          ...
          <p className="md:max-w-[580px] text-center text-[10px] md:text-xl mx-auto">
            We are a dedicated team of experienced professionals committed to
            meeting our clients' needs with innovative solutions and a
            transparent process. Our client-centric approach prioritizes your
            expectations, ensuring satisfaction through results that exceed
            expectations.
          </p>
        </div>
      </div>
