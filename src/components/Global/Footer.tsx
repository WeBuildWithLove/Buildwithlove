...
function Footer() {
  return (
    ...
    <div>Lorem ipsum dolor sit amet consectetur adipisicing elit. Cumque officia a minima perferendis harum iusto provident aliquid cupiditate distinctio cum ea dolorum sequi, architecto dignissimos inventore aspernatur pariatur repellendus dicta!</div>
    </div>
  )
}
